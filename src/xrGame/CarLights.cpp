...
void SCarLight::ParseDefinitions(LPCSTR section)
{
	...
	light_render->set_volumetric(ini->r_bool("volumetric_enable"));
	light_render->set_volumetric_distance(ini->r_float("volumetric_distance"));
	light_render->set_volumetric_intensity(ini->r_float("volumetric_intensity"));
	light_render->set_volumetric_quality(ini->r_float("volumetric_quality"));
