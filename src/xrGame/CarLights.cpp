...
void SCarLight::ParseDefinitions(LPCSTR section)
{
	...
	light_omni->set_range	(READ_IF_EXISTS(ini,r_float,section,"range_omni",1.0f));
	
	light_render->set_volumetric(READ_IF_EXISTS(ini,r_bool,section,"volumetric",FALSE));
	light_render->set_volumetric_distance(READ_IF_EXISTS(ini,r_float,section,"volumetric_distance",0.7f));
	light_render->set_volumetric_intensity(READ_IF_EXISTS(ini,r_float,section,"volumetric_intensity",0.47f));
	light_render->set_volumetric_quality(READ_IF_EXISTS(ini,r_float,section,"volumetric_quality",2.0f));
